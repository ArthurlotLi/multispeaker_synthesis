...
#
# Executes training of the speaker_encoder model. Allows user to 
# specify various aspects of the model training process.
#
# By default, expects preprocessed data to be at
# ./datasets/SV2TTS/encoder. You can change this with the -d option.
#
# Ensure you start Visdom first if you have enabled visualization! 
...
if __name__ == "__main__":
  ...
  parser.add_argument("-u", "--umap_every", type=int, default=1000, help= \
